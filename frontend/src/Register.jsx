    ...
    return (
        <div className="font-sans h-screen antialiased flex justify-center items-center bg-slate-2000" style={{border:"1px solid black"}}>
            <div className="flex flex-col justify-center items-center w-full lg:w-1/2 p-8 h-full relative">
                ...
                <form className="w-8/12 " style={{border:"2px solid black", backgroundColor: "white", padding: "20px", zIndex: 1,borderRadius:"30px",marginBottom:"100px",marginRight:"5    00px"}}> {/* Added background color and positioning */}
                    <div className="mb-1">
