...
export default function Login() {
  ...
  return (
    ...
    <div className="font-sans	 antialiased flex justify-center items-center  bg-slate-200" style={{marginTop:"30px"}} >
      ...
      <div className="hidden lg:flex w-1/2 border p-0 h-full mr-10"
