...
function ProductDetail() {
    ...
    return (
        <div className="container mx-auto p-2 bg-gradient-to-r from-richblack-25 to-blue-500  h-screen">
            <div className="flex flex-col md:flex-row md:space-x-4 bg-gradient-to-r from-richblack-25 to-blue-500  p-5">
                ...
                {/* card1 */}
                    ...
                    <div className="w-[500px] bg-white rounded-xl shadow-lg p-3 mt-3 ">
                     ...
                     {/* card3 chat */}
                    <div class="py-8 px-8 mt-3  w-full mx-auto bg-white rounded-xl shadow-lg space-y-2 sm:py-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-6">
